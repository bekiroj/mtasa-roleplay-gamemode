local spoilerPrice = 1000
local hoodPrice = 1000
local sideskirtPrice = 1000
local roofPrice = 1000
local lightPrice = 1000
local wheelPrice = 1000
local exhaustPrice = 1000
local bullbarPrice = 1000
local bumperPrice = 1000
vehicle_upgrades = {
