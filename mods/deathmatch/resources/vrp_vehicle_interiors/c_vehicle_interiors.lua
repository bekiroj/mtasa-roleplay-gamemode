...
addEvent("vehicle_interiors:showInteriorGUI", true)
addEventHandler("vehicle_interiors:showInteriorGUI", getRootElement(), vehInteriorGUI)
...
addEvent("vehicle_interiors:hideInteriorGUI", true)
addEventHandler("vehicle_interiors:hideInteriorGUI", getRootElement(), hideVehInteriorGUI)
...
addEvent("vehicle_interiors:changeTextures", true)
addEventHandler("vehicle_interiors:changeTextures", getRootElement(), changeTexture)
