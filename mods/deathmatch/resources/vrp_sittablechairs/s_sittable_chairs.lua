function sitOnChair(x, y, z, rz, chair, offset)
	...
	exports.vrp_global:applyAnimation( source, "FOOD", "FF_Sit_Look", -1, true, false, true)
	exports.vrp_global:sendLocalMeAction(source, "sağ eli ile sandalyeyi kendine doğru çeker ve oturur.")
...
function standUp(chair)
	...
	exports.vrp_global:sendLocalMeAction(client, "yavaşça doğrulur ve sandalyeden kalkar.")
