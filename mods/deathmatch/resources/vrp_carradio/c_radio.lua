...
function draw()
	...
	if mp3Station and mp3Station ~= nil then
		...
		dxDrawImage ( left-10, top - 2, 50, 50, ":vrp_hud/images/radio.png" ,0, 0, 0, tocolor(255,255,255), true )
...
function showMP3GUI()
	...
	mp3Window = guiCreateStaticImage(mp3_x, mp3_y, mp3_w, mp3_h, ":vrp_resources/window_body.png", false)
