...
addEventHandler("onClientRender",getRootElement(), function ()
	if showTopRightReportBox(localPlayer) and not getElementData(localPlayer, "integration:previewPMShowing") and exports.vrp_hud:isActive() then 
...
function startAutoUpdate()
	...
	elseif exports.vrp_integration:isPlayerSupporter(localPlayer) then
