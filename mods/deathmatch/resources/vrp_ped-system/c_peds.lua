...
function canPlayerUseLevel(level)
	if level == 0 then
		return true
	elseif level == 1 then
		return exports.vrp_integration:isPlayerTrialAdmin(localPlayer) or exports.vrp_integration:isPlayerScripter(localPlayer)
	elseif level == 2 then
		return exports.vrp_integration:isPlayerAdmin(localPlayer) or exports.vrp_integration:isPlayerScripter(localPlayer)
	elseif level == 3 then
		return exports.vrp_integration:isPlayerLeadAdmin(localPlayer) or exports.vrp_integration:isPlayerScripter(localPlayer)
	elseif level == 4 then
		return exports.vrp_integration:isPlayerHeadAdmin(localPlayer) or exports.vrp_integration:isPlayerScripter(localPlayer)
	elseif level == 5 then
		return exports.vrp_integration:isPlayerScripter(localPlayer)
	end
	return false
end
