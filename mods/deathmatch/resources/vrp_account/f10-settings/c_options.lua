...
function options_showmenu()
	...
	wOptions = guiCreateStaticImage(left, top, windowWidth, windowHeight, ":vrp_resources/window_body.png", false)
	...
	if getResourceFromName("vrp_admins") and exports['vrp_admins']:canPlayerAccessStaffManager(localPlayer) then
	...
	if getResourceFromName("vrp_factions") and exports.vrp_factions:canAccessFactionManager( localPlayer ) then
	...
	if getResourceFromName("vrp_interiors") and getResourceFromName("vrp_interior_manager") and exports.vrp_integration:isPlayerAdmin( localPlayer ) then
	...
	if getResourceFromName("vrp_vehicle") and getResourceFromName("vrp_vehicle_manager") and exports.vrp_vehicle_manager:canAccessVehicleManager( localPlayer ) then
	...
	if getResourceFromName('vrp_vehicle') and getResourceFromName("vrp_vehicle_manager") then
	...
	exports.vrp_global:centerWindow(wOptions)
end
