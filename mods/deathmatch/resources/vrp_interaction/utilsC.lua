...
function dxDrawInteractionButton(key, label, x, y, w, h, buttonColor, activeColor, textColor, font, textAlign1, textAlign2, imagePath, imageW, imageH, imageColor)
    ...
    if imagePath then
        ...
        dxDrawText(label, x + imageW + respc(5), y, x + w, y + h, tocolor(230,230,230, 255 * fadeAmount), 1, font, textAlign1, textAlign2)
    else
        dxDrawText(label, x + respc(5), y, x + w, y + h, tocolor(230,230,230, 255 * fadeAmount), 1, font, textAlign1, textAlign2)
    ...
    if activeDirectX ~= lastActiveDirectX and activeDirectX then
        sound = playSound(":assets/audio/interface/hover.ogg")
